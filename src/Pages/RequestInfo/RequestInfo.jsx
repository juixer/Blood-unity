    ...
    <div>
      <Container>
        ...
        <div
          ...
          style={{
            backgroundImage: "url(https://i.ibb.co/PQt8Jx0/infoGIf.gif)",
          }}
        >
          ...
          <div className="hero-content text-center text-neutral-content">
            <div className="max-w-3xl">
              <div className="space-y-3">
                ...
                <h1 className="text-xl">
                  <span className="font-bold">Donate Date:</span>{" "}
                  {donation.donation_date}
                </h1>
                <h1 className="text-xl">
                  <span className="font-bold">Donate Time:</span>{" "}
                  {donation.donation_time}
                </h1>
                <p className="text-xl">
                  <span className="font-bold">Requester Message:</span>{" "}
                  {donation.message}
                </p>
              </div>
